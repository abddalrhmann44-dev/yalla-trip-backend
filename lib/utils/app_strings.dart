// ═══════════════════════════════════════════════════════════════
//  YALLA TRIP — Complete Translation System
...
class S {
  ...
  static String get invalidEmail   => _ar ? 'بريد إلكتروني غير صحيح' : 'Invalid email';
  static String get weakPassword   => _ar ? 'كلمة مرور ضعيفة (6 أحرف على الأقل)' : 'Weak password (min 6 chars)';
  static String get passMismatch   => _ar ? 'كلمتا المرور غير متطابقتين' : 'Passwords do not match';
  ...
  static String areaName(String ar) {
    switch (ar) {
      case 'عين السخنة':     return _ar ? ar : 'Ain Sokhna';
      case 'الساحل الشمالي': return _ar ? ar : 'North Coast';
      case 'الجونة':         return _ar ? ar : 'El Gouna';
      case 'الغردقة':        return _ar ? ar : 'Hurghada';
      case 'شرم الشيخ':      return _ar ? ar : 'Sharm El Sheikh';
      case 'رأس سدر':        return _ar ? ar : 'Ras Sedr';
      default:               return ar;
    }
  }
  ...
  static String catName(String ar) {
    switch (ar) {
      case 'شاليه':     return _ar ? ar : 'Chalet';
      case 'شاليهات':   return _ar ? ar : 'Chalets';
      case 'فيلا':      return _ar ? ar : 'Villa';
      case 'فيلات':     return _ar ? ar : 'Villas';
      case 'فندق':      return _ar ? ar : 'Hotel';
      case 'فنادق':     return _ar ? ar : 'Hotels';
      case 'منتجع':     return _ar ? ar : 'Resort';
      case 'منتجعات':   return _ar ? ar : 'Resorts';
      case 'أكوا بارك': return _ar ? ar : 'Aqua Park';
      case 'بيت شاطئ':  return _ar ? ar : 'Beach House';
      case 'الكل':      return _ar ? ar : 'All';
      case 'غوص':       return _ar ? ar : 'Diving';
      case 'مارينا':    return _ar ? ar : 'Marina';
      case 'رياضات بحرية': return _ar ? ar : 'Sea Sports';
      default:          return ar;
    }
  }

  // ── WELCOME PAGE ────────────────────────────────────────────
  static String get welcomeTagline  => _ar ? 'اكتشف • احجز • استمتع'
                                           : 'Discover • Book • Enjoy';
  static String get welcomeSubtitle => _ar ? 'أجمل الشاليهات والفيلات\nعلى الساحل المصري'
  ...
  static String get loginSubtitle   => _ar ? 'أهلاً بك مجدداً في Yalla Trip'
                                           : 'Welcome back to Yalla Trip';
  ...
  static String get emailPlaceholder=> _ar ? 'البريد الإلكتروني'   : 'Email Address';
  static String get passPlaceholder => _ar ? 'كلمة المرور'         : 'Password';
  static String get confirmPass     => _ar ? 'تأكيد كلمة المرور'   : 'Confirm Password';
  static String get forgotPass      => _ar ? 'نسيت كلمة المرور؟'   : 'Forgot password?';
  ...
  static String get noAccount       => _ar ? 'مش عندك حساب؟'      : 'Don\'t have an account?';
  static String get registerLink    => _ar ? 'سجّل الآن'           : 'Register now';
  static String get hasAccount      => _ar ? 'عندك حساب بالفعل؟'  : 'Already have an account?';
  static String get loginLink       => _ar ? 'تسجيل الدخول'        : 'Sign In';
  static String get registerTitle   => _ar ? 'إنشاء حساب'          : 'Create Account';
  static String get registerSub     => _ar ? 'انضم لـ Yalla Trip واكتشف أجمل الوجهات'
  ...
  static String get otpSubtitle     => _ar ? 'أدخل الكود المرسل إلى' : 'Enter the code sent to';
  static String get otpEnterCode    => _ar ? 'أدخل الكود المكون من 6 أرقام كاملاً'
  ...
  static String get otpWrong        => _ar ? 'الكود غير صحيح، حاول مرة أخرى'
                                           : 'Incorrect code, please try again';
  static String get otpExpired      => _ar ? 'انتهت صلاحية الكود، اطلب كوداً جديداً'
                                           : 'Code expired, request a new one';
  static String get otpInvalid      => _ar ? 'الكود المدخل غير صحيح' : 'Invalid code entered';
  static String get otpResent       => _ar ? 'تم إرسال كود جديد ✅' : 'New code sent ✅';
  static String get otpResendFailed => _ar ? 'فشل إرسال الكود، حاول مرة أخرى'
                                           : 'Failed to send code, try again';

  // ── HOME PAGE ───────────────────────────────────────────────
  static String get searchHint     => _ar ? 'ابحث عن شاليه، منتجع، أو شاطئ…'
  ...
  static String get destinations   => _ar ? 'الوجهات الساحلية'    : 'Beach Destinations';
  static String get bookNow        => _ar ? 'استكشف الآن'          : 'Explore Now';
  static String get featuredProps  => _ar ? 'عقارات مميزة'         : 'Featured Properties';
  ...
  // Hero
  static String get ainSokhnaSub   => _ar ? 'عروض حتى 40% خصم'    : 'Up to 40% off deals';
  static String get hurghadaSub    => _ar ? 'شعاب مرجانية وبحر بلوري' : 'Coral reefs & crystal sea';
  static String get northCoastSub  => _ar ? 'شواطئ بيضاء راقية'   : 'Premium white beaches';
  static String get sharmSub       => _ar ? 'جنة الغطس والاسترخاء' : 'Diving & relaxation paradise';
  ...
  static String get onlineOnly     => _ar ? 'دفع أونلاين فقط'     : 'Online Payment Only';
  ...
  static String get noResultsSub   => _ar ? 'جرّب تغيير الفلاتر أو البحث بكلمة مختلفة'
  ...
  static String get noPropsArea    => _ar ? 'لا توجد عقارات في هذه المنطقة'
                                          : 'No properties in this area';
  static String get comingSoon     => _ar ? 'جاري إضافة عقارات جديدة قريباً'
  ...
  static String get guestNotePlh   => _ar ? 'أي طلبات أو ملاحظات خاصة…'
                                          : 'Any special requests…';
  static String get nightsCount    => _ar ? 'عدد الليالي'          : 'Nights';
  static String get pricePerNight  => _ar ? 'سعر الليلة'           : 'Price per night';
  static String get proceedPayment => _ar ? 'المتابعة للدفع'       : 'Proceed to Payment';
  static String get minNightsMsg   => _ar ? 'الحد الأدنى'          : 'Minimum';
  static String get dateRange      => _ar ? 'تاريخ الوصول والمغادرة' : 'Check-in & Check-out';
  ...
  static String get visaMaster     => _ar ? 'فيزا / ماستر كارد'    : 'Visa / Mastercard';
  static String get visaDesc       => _ar ? 'بطاقة ائتمان أو خصم مباشر' : 'Credit or debit card';
  static String get meeza          => _ar ? 'ميزة'                  : 'Meeza';
  static String get meezaDesc      => _ar ? 'البطاقة الوطنية المصرية' : 'Egyptian national card';
  static String get fawry          => _ar ? 'فوري Pay'              : 'Fawry Pay';
  static String get fawryDesc      => _ar ? 'ادفع إلكترونياً عبر فوري' : 'Pay via Fawry';
  static String get vodafone       => _ar ? 'فودافون كاش'           : 'Vodafone Cash';
  static String get vodafoneDesc   => _ar ? 'ادفع عبر محفظة فودافون' : 'Pay via Vodafone wallet';
  static String get payNow         => _ar ? 'ادفع الآن'             : 'Pay Now';
  static String get orderSummary   => _ar ? 'ملخص الطلب'           : 'Order Summary';
  static String get paymentSuccess => _ar ? 'تم الدفع بنجاح 🎉'    : 'Payment Successful 🎉';
  static String get paymentFailed  => _ar ? 'فشل الدفع'             : 'Payment Failed';
  static String get platformFee    => _ar ? 'رسوم المنصة (8%)'     : 'Platform Fee (8%)';
  static String get ownerReceives  => _ar ? 'يستلم المالك (92%)'    : 'Owner receives (92%)';
  static String get bookingConfirmed=> _ar ? 'تم تأكيد الحجز ✅'   : 'Booking Confirmed ✅';
  ...
  static String get noBookings     => _ar ? 'لا توجد حجوزات بعد'  : 'No bookings yet';
  static String get noBookingsSub  => _ar ? 'ابدأ باستكشاف الوجهات وأحجز رحلتك القادمة'
  ...
  static String get noNotifications   => _ar ? 'لا توجد إشعارات'  : 'No notifications yet';
  static String get markAllRead       => _ar ? 'تحديد الكل كمقروء' : 'Mark all as read';
  ...
  static String get darkModeDesc   => _ar ? 'تحويل للثيم الداكن'   : 'Switch to dark theme';
  ...
  static String get logoutConfirm  => _ar ? 'هل تريد تسجيل الخروج؟' : 'Sign out?';
  static String get deleteAccount  => _ar ? 'حذف الحساب'           : 'Delete Account';
  static String get deleteConfirm  => _ar ? 'هل أنت متأكد من حذف حسابك؟'
                                          : 'Are you sure? This cannot be undone.';
  static String get becomeOwner    => _ar ? 'هل عندك عقار؟'        : 'Own a Property?';
  static String get becomeOwnerSub => _ar ? 'حوّل حسابك لمالك وضيف عقارك الآن'
                                          : 'List your property and start earning';
  static String get switchGuest    => _ar ? 'التبديل لوضع العميل'  : 'Switch to Guest Mode';
  static String get ownerMode      => _ar ? 'أنت في وضع المالك'   : 'You\'re in Owner Mode';
  ...
  static String get totalRevenue   => _ar ? 'إجمالي ما استلمته'    : 'Total Earnings';
  static String get addProperty    => _ar ? 'إضافة عقار جديد'      : 'Add New Property';
  static String get addPropertySub => _ar ? 'أضف شاليهك أو فيلتك في دقائق'
                                          : 'Add your chalet or villa in minutes';
  static String get noBookingsYet  => _ar ? 'لا يوجد حجوزات بعد'  : 'No bookings yet';
  static String get support        => _ar ? 'الدعم'                : 'Support';
  static String get notifBookings  => _ar ? '📅 تحديثات الحجز'    : '📅 Booking Updates';
  static String get notifBookingsSub=> _ar ? 'اعرف أي جديد في حجوزاتك'
                                           : 'Stay updated on your bookings';
  static String get notifMessages  => _ar ? '💬 الرسائل'           : '💬 Messages';
  static String get notifMessagesSub=> _ar ? 'رسائل جديدة من الملاك أو الضيوف'
                                           : 'New messages from owners or guests';
  static String get notifDeals     => _ar ? '⚡ عروض خاصة'        : '⚡ Special Offers';
  static String get notifDealsSub  => _ar ? 'عروض محدودة الوقت على العقارات'
                                          : 'Limited time deals';
  ...
  static String get ownerBookings  => _ar ? 'الحجوزات الواردة'     : 'Incoming Bookings';
  ...
  static String get noListings     => _ar ? 'لا توجد عقارات بعد'  : 'No listings yet';
  static String get noListingsSub  => _ar ? 'أضف عقارك الأول وابدأ في الكسب'
  ...
  // ── ADD PROPERTY ────────────────────────────────────────────
  static String get addPropertyTitle => _ar ? 'إضافة عقار جديد'   : 'Add New Property';
  ...
  static String get pricePerNightL => _ar ? 'السعر لكل ليلة'       : 'Price per Night';
  ...
  static String get propertyAmenities => _ar ? 'المرافق والخدمات'  : 'Amenities & Services';
  ...
  static String get minNightsL     => _ar ? 'الحد الأدنى للليالي'  : 'Minimum Nights';
  static String get maxNightsL     => _ar ? 'الحد الأقصى للليالي'  : 'Maximum Nights';
}
