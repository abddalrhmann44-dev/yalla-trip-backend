...
class _YallaTripAppState extends State<YallaTripApp> {
    ...
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        switch (settings.name) {
          ...
          case '/payment':
            // PaymentPage is now reached via BookingFlowPage → PropertyDetailsPage
            // Direct route removed — navigate through property_details_page instead
  ...
  ThemeData _buildTheme(Brightness brightness) {
    ...
    final base = ThemeData(
      ...
      scaffoldBackgroundColor: isDark ? const Color(0xFF0D1117) : const Color(0xFFF5F3EE),
    );
